<!DOCTYPE html>
	...
	?>
		...
		<button style='width:240px;text-align:center;border:solid;width:100px;border-radius:20px;outline:none;background: transparent;' onclick="goBack()">Go Back</button>
