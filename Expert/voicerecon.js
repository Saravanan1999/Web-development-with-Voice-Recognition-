    ...
    recognition.onresult = function (e) {
        ...
        for (var i = e.resultIndex; i < e.results.length; ++i) {
            ...
            if (e.results[i].isFinal) {
                ...
                if (splited_text[0] == 'viewpage') {
                    document.location.href = 'view.php'
                    speak("moving to view page ")
                }
                if (splited_text[0] == 'servicepage') {
              ...
              if (splited_text[0] == 'click' || splited_text[0] == 'focus' || splited_text[0] == 'press') {
                ...
                /*if (splited_text[0] == 'check') {
                    if(splited_text[1]=='male'){
                        doc=document.getElementById('Male')=true;
                        speak("Male is checked");
                    }
                    else if(splited_text[1]=='female'){
                        doc=document.getElementById('female');
                        doc.checked=true;
                        speak("Female is checked");
                    }
                    else{
                        doc=document.getElementById('other');
                        doc.checked=true;
                        speak('Others is checked');
                    }
                    console.log('Check called')
                ...
                // console.log(splited_text[0]);                
                    ...
                    if (splited_text[0] == 'view') {
                        document.location.href = 'view.php';
                        speak("moving to " + splited_text);
                    }
                    if (splited_text[0] == 'service') {
                        document.location.href = 'Services.php';
                        speak("moving to " + splited_text);
                    }
