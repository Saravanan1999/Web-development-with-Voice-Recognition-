    ...
    recognition.onresult = function (e) {
        ...
        for (var i = e.resultIndex; i < e.results.length; ++i) {
            ...
            if (e.results[i].isFinal) {
               ...
               if (splited_text[0] == 'titlepage') {
                    document.location.href = 'title.php'
                    speak("moving to homepage ")
                }
                if (splited_text[0] == 'signpage') {
                    document.location.href = 'a/Signup.php'
                    speak("moving to sign up page ")
                }
                if (splited_text[0] == 'complainant') {
                    document.location.href = 'a/login.php'
                    speak("moving to sign up page ")
                }
                if (splited_text[0] == 'expert') {
                    document.location.href = 'b/login.php';
                    speak("moving to " + splited_text);
                }
